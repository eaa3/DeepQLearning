...
function Environment:new(width,height)
    ...
    function env.action_space:sample()
    	return love.math.random( #self.actions )
    end
    ...
    function env:getState()
        ...
        return {px, py, vx/PPM, vy/PPM, fpx - px, fpy - py, epx - px, epy - py}
    end
    ...
    function env:getNActions()
        return #env.action_space.actions
    end
